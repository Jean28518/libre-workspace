...
class BackupSettings(forms.Form):
    ...
    keep_daily_backups = forms.IntegerField(label="Anzahl der täglichen Backups", min_value=0, max_value=1000, widget=forms.NumberInput(attrs={"placeholder": "7"}))
    keep_weekly_backups = forms.IntegerField(label="Anzahl der wöchentlichen Backups", min_value=0, max_value=1000, widget=forms.NumberInput(attrs={"placeholder": "6"}))
    keep_monthly_backups = forms.IntegerField(label="Anzahl der monatlichen Backups", min_value=0, max_value=1000, widget=forms.NumberInput(attrs={"placeholder": "12"}))
