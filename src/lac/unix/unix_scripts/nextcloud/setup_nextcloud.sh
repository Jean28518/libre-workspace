...
apt install caddy mariadb-server php-gd php-mysql php-curl php-mbstring php-intl php-gmp php-bcmath php-imap php-xml php-bz2 php-imagick libmagickcore-6.q16-6-extra php-zip php-fpm php-redis php-apcu php-memcache php-sqlite3 unzip vim -y
