...
Libre Workspace consists of a set of software packages designed to implement a modern cloud infrastructure for companies or individuals. It is based on the following software:
...
* `Cinnamon <https://linuxmint.com/>`_, `xrdp <https://www.xrdp.org/>`_ and `guacamole <https://guacamole.apache.org/>`_ as the Linux Cloud Desktop solution for the web browser.
* `Wordpress <https://wordpress.org/>`_ for creating websites.

Features
========

Next to the software components mentioned above, Libre Workspace provides the following features:
...
* **Backups of the whole system** via BorgBackup, with a restore function in the web interface
...
* **Add-on support**, including an add-on store for easy installation of additional modules. Add-ons can also be created easily with the integrated add-on creator.
...
You can set up Libre Workspace on your own by following the instructions in this documentation via our automated installation.